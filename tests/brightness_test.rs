...
mod color_transform_brightness_test {
    ...
    fn color_transform_brightness_test_0() -> Result<()> {
        ...
        Surface::color_transform_brightness(&mut base_image_surface, &mut output_surface, 0.0);
    ...
    fn color_transform_brightness_test_1() -> Result<()> {
        ...
        Surface::color_transform_brightness(&mut base_image_surface, &mut output_surface, 1.0);
        // eprintln!("Created gaussian blur");
    ...
    fn color_transform_brightness_test_1_75() -> Result<()> {
        ...
        Surface::color_transform_brightness(&mut base_image_surface, &mut output_surface, 1.75);
        // eprintln!("Created gaussian blur");
    ...
    fn color_transform_brightness_test_50() -> Result<()> {
        ...
        Surface::color_transform_brightness(&mut base_image_surface, &mut output_surface, 0.50);
        // eprintln!("Created gaussian blur");
