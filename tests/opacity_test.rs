...
mod color_transform_opacity_test {
    ...
    fn color_transform_opacity_test_0() -> Result<()> {
        ...
        Surface::color_transform_opacity(&mut base_image_surface, &mut output_surface, 0.0);
    ...
    fn color_transform_opacity_test_25() -> Result<()> {
        ...
        Surface::color_transform_opacity(&mut base_image_surface, &mut output_surface, 0.25);
        // eprintln!("Created gaussian blur");
    ...
    fn color_transform_opacity_test_50() -> Result<()> {
        ...
        Surface::color_transform_opacity(&mut base_image_surface, &mut output_surface, 0.50);
        // eprintln!("Created gaussian blur");
    ...
    fn color_transform_opacity_test_75() -> Result<()> {
        ...
        Surface::color_transform_opacity(&mut base_image_surface, &mut output_surface, 0.75);
        // eprintln!("Created gaussian blur");
    ...
    fn color_transform_opacity_test_100() -> Result<()> {
        ...
        Surface::color_transform_opacity(&mut base_image_surface, &mut output_surface, 1.0);
        // eprintln!("Created gaussian blur");
